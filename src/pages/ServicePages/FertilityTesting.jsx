...
const FertilityTesting = () => {
  const procedureCards = [
     {
      ...
      icon: <UserCheck className="text-teal-600" size={30} />
    },
    {
      title: "Testing Phase",
    ...
    },
    {
      ...
      icon: <FileText className="text-teal-600" size={30} />
    }
  ];
  ...
  return (
    <div className="bg-white pb-20">
      {/* 1. Name & Bio */}
      <section className="pt-32 pb-12 bg-gradient-to-b from-[#FBF6F6]/50 to-white">
        <Container>
          <div className="max-w-4xl text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
              Fertility <span className="text-teal-600">Testing</span>
            </h1>
            <p className="text-xl text-teal-600 font-medium leading-relaxed">
      ...
      <Container>
        ...
        <div className="py-8 max-w-4xl text-left">
          <p className="text-gray-600 leading-relaxed text-lg border-l-4 border-[#dbe3bc] pl-6 italic">
        ...
        <section className="py-12 max-w-4xl text-left">
            ...
            <div className="h-1.5 w-20 bg-teal-600 mb-8 rounded-full"></div>
          ...
          <div className="bg-[#F0F7F4]/50 rounded-[15px] p-4 md:p-6 max-w-lg shadow-sm border border border-[#F0F7F4]">
        
            <h3 className="text-teal-600 font-semibold text-lg md:text-xl mb-5">
                What We Check
            </h3>
            ...
            <ul className="space-y-4">
                ...
                <li key={index} className="flex items-start gap-3 text-gray-700">
                    ...
                    <span className="w-2.5 h-2.5 mt-2 rounded-full bg-teal-600"></span>
        ...
        <section className="py-12 bg-[#F0F7F4]/50 rounded-[30px] md:rounded-[40px] px-6 md:px-16 my-12 border border-[#F0F7F4]">
        <div className="grid md:grid-cols-2 gap-12">
            
            {/* Female Testing Column */}
            <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-6 flex items-center gap-2">
                <span className="w-2 h-8 bg-teal-600 rounded-full inline-block"></span>
            ...
            {/* Male Testing Column */}
            <div className="border-t md:border-t-0 md:border-l border-[#F0F7F4] pt-8 md:pt-0 md:pl-12">
            <h3 className="text-2xl font-bold text-slate-800 mb-6 flex items-center gap-2">
                <span className="w-2 h-8 bg-[#FBF4D4]0 rounded-full inline-block"></span>
        ...
        <div className="grid md:grid-cols-3 gap-8 py-12 text-center">
          {procedureCards.map((card, i) => (
            <div key={i} className="bg-white border border-slate-100 p-8 md:p-10 rounded-[30px] md:rounded-[35px] shadow-xl shadow-blue-100/20 hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full bg-blue-100 text-teal-600 font-bold text-lg">
                  {i + 1}
              </div>
        ...
        <div className="mt-12 md:mt-24 bg-slate-900 rounded-[30px] md:rounded-[50px] p-10 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 w-80 h-80 bg-teal-600/20 blur-[100px] rounded-full"></div>
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-8 leading-tight">
              Start Your Journey <br /> With Clarity
            </h2>
            <Link to="/appointment"
              className="inline-flex items-center gap-3 bg-teal-600 text-white px-8 md:px-10 py-4 md:py-5 rounded-full font-bold text-lg hover:bg-teal-700 transition-all shadow-xl shadow-[#1E293B]/40 active:scale-95">
