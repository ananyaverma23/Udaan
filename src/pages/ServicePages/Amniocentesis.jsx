          ...
          <div className="flex md:grid md:grid-cols-5 gap-6 overflow-x-auto md:overflow-visible pb-4 items-stretch">
            ...
            {[
              ...
              <div key={i} className="min-w-[250px] md:min-w-0 flex flex-col items-center text-center relative h-full">
                ...
                {i !== 4 && (
                  <div className="hidden md:block absolute top-6 right-[-50%] w-full h-1 bg-gradient-to-r from-blue-500 to-violet-500" />
                )}

                <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-600 to-violet-600 text-white flex items-center justify-center font-bold mb-4">
                  {i + 1}
                </div>
